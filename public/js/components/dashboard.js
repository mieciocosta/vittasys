...
const cards=[{l:'Doses em Estoque',v:data.estoque.total_doses,c:'#2BBCB3',i:I.box},{l:'Contratos Ativos',v:data.planos.total_contratos,c:'#1B4965',i:I.pkg},{l:'Receita Total',v:fmtMoeda(data.financeiro.total_recebido),c:'#059669',i:I.dollar},{l:'Alertas',v:(data.estoque.proximos_vencer||0)+(data.estoque.vencidos||0),c:data.estoque.proximos_vencer>0?'#dc2626':'#059669',i:I.alert}];
