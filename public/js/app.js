(function(){const root=document.getElementById('app');AppState.subscribe(renderApp);renderApp();
async function renderApp(){root.innerHTML='';
...
try{main.appendChild(await(map[AppState.modulo]||renderDashboard)())}
catch(e){console.error(e);main.appendChild(h('div',{className:'empty-state'},`Erro: ${e.message}`))}
